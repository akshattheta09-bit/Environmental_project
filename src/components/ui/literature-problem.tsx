    ...
    <section className="py-24 md:py-32 px-6 md:px-12 max-w-4xl mx-auto border-t border-border/30">
      <motion.div {...fadeUp} className="mb-12">
        ...
        <div className="prose prose-lg dark:prose-invert prose-p:font-light prose-p:leading-relaxed prose-p:text-muted-foreground prose-strong:text-foreground prose-strong:font-semibold">
          <p>
            Extensive academic literature documents the severe intersection of urban traffic management and environmental sustainability. Researchers globally have examined how vehicular congestion directly exacerbates air pollution, greenhouse gas emissions, noise pollution, and urban heat island effects. In 2022 alone, the globally emitted transport sector reached roughly <strong>8.4 gigatons of CO₂</strong>, representing 23% of total energy-related emissions.
          </p>
          <p>
            Traffic congestion dramatically increases vehicle idling time — the period when an engine runs without the vehicle moving. Studies show that idling engines emit up to <strong>80% more CO₂ per kilometre</strong> equivalent than vehicles moving at optimal speeds.
          </p>
          <p>
            The global cost of traffic congestion exceeds <strong>$1 trillion annually</strong> in productivity loss and fuel waste. Beyond time lost, traditional fixed-timer traffic systems are rigid; they lack integration with air quality monitoring and cannot predict non-recurrent congestion events — events that account for roughly <strong>60% of all urban delays</strong>. 
          </p>
          <p>
            Furthermore, human operators in traditional traffic management centers inevitably face cognitive overload when attempting to manually re-route or adjust signal networks during catastrophic, multi-node incidents.
          </p>
        </div>
      </motion.div>
